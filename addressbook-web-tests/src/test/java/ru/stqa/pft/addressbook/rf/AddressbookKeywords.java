...
public class AddressbookKeywords {
  ...
  public static final String ROBOT_LIBRARY_SCOPE = "GLOBAL";    // сделали константу, которая указывает тип библиотеки; теперь библиотека инициализруется один раз и будет использоваться для всех тестовых сценариев
